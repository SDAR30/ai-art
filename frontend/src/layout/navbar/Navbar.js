        ...
        <div className="navbar">
            ...
            <div className='navbar__buttons'>
                ...
                <div className={active ? "navbar__menuItems-active" : "navbar__menuItems"} onClick={() => setActive(false)}>
                    <li className="navbar__menuItem"> <NavLink style={({ isActive }) => ({ color: isActive ? "grey" : "white", cursor: isActive ? 'default' : 'pointer' })} to="/">Gallery</NavLink ></li>
                    <li className="navbar__menuItem"><NavLink style={({ isActive }) => ({ color: isActive ? "grey" : "white", cursor: isActive ? 'default' : 'pointer' })}  to="/about">About</NavLink></li>
                    <li className="navbar__menuItem"><NavLink style={({ isActive }) => ({ color: isActive ? "grey" : "white", cursor: isActive ? 'default' : 'pointer' })} to="/contact">Contact</NavLink></li>
                    <li className="navbar__menuItem"><NavLink style={({ isActive }) => ({ color: isActive ? "grey" : "white", cursor: isActive ? 'default' : 'pointer' })}   to="images/create">Create</NavLink></li>
